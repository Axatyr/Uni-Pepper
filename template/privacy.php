<h1><span class="fas fa-user-shield"></span> <?php echo $templateParams["titolo_pagina"]; ?></h1>
        ...
        <h3>Perché trattiamo i dati?</h3>
            ...
            <p>Le è consentito visitare il sito senza rivelare informazioni, tramite le quale potrebbe essere identificato personalmente. Se, tuttavia, desidera utilizzare alcune delle funzioni del sito, o desidera ricevere newsletter o fornire altri dettagli compilando un modulo, potrebbe doverci fornire dati personali come email, nome, cognome, città di residenza, organizzazione e numero di telefono. Può scegliere di non fornire dati personali, tuttavia in tal caso non potrà usufruire di alcune funzioni del sito. Per esempio, non potrà ricevere la nostra newsletter o contattarci direttamente dal sito. Gli utenti che non sanno quali informazioni sono obbligatorie, possono contattarci a alessandro@unipeppers.it.</p>
        ...
        <h3>I Suoi diritti:</h3>
            ...
            <p>Per esercitare questi diritti, contattarci tramite le informazioni di contatto sotto.</p>
        ...
        <h3>Sicurezza delle informazioni:</h3>
        ...
        <h3>Informazioni di contatto:</h3>
            <p>Per qualsiasi questione correlata ai diritti individuali o alle informazioni personali, può inviare un'email a alessandro@unipeppers.it.</p>
