<h1><span class="fas fa-user-shield"></span> <?php echo $templateParams["titolo_pagina"]; ?></h1>
            <p>Le diamo il benvenuto su Unipeppers!</p>
            <p>I termini e le condizioni seguenti indicano regole e normative per l'utilizzo del sito di Unipeppers, all'indirizzo www.unipeppers.it.</p>
            <p>Accedendo a questo sito, Lei accetta i termini e le condizioni seguenti. Le chiediamo di non continuare ad usare Unipeppers nel caso in cui non fosse d'accordo con tutti i termini e le condizioni in questa pagina.</p>
        
        <h3>Cookie:</h3>
            <p>Il sito utilizza cookie per personalizzare l'esperienza online. Accedendo a Unipeppers, accetta l'uso dei cookie richiesti.</p>
        ...
        <h3>Licenza:</h3>
            <p>A meno che indicato altrimenti, Unipeppers e/o gli affiliati con licenza detengono i diritti di proprietà intellettuale per tutto il materiale su Unipeppers. Tutti i diritti di proprietà intellettuale sono riservati. Può accedervi tramite Unipeppers per uso personale soggetto a restrizioni indicate nei termini e nelle condizioni seguenti.</p>
            <p>Non è consentito:</p>
            <ul>
                <li>Copiare o ripubblicare il materiale di Unipeppers</li>
                <li>Vendere, noleggiare o fornire in sub-licenza il materiale di Unipeppers</li>
                <li>Riprodurre, duplicare o copiare il materiale di Unipeppers</li>
                <li>Ridistribuire contenuti di Unipeppers</li>
            </ul>
            <p>Il presente accordo ha inizio dalla data qui indicata.</p>
            <p>Parti di questo sito offrono all'utente la possibilità di pubblicare e scambiare opinioni e informazioni in certe aree del sito. Unipeppers non filtra, modifica, pubblica o revisiona i commenti prima di aggiungerli sul sito. I commenti non riflettono il punto di vista e l'opinione di Unipeppers, dei suoi agenti e/o dei suoi affiliati. I commenti riflettono punto di vista e opinione di colui che pubblica tale punto di vista o opinione. Nella misura consentita dalla legge, Unipeppers non deve essere ritenuta responsabile per i commenti e non può ricevere richieste di risarcimento danni o spese causate dall'uso, dalla pubblicazione e/o dalla presenza dei commenti sul sito.</p>
            <p>Unipeppers si riserva il diritto di monitorare tutti i commenti e rimuovere quelli che considera non appropriati, offensivi o in violazione con i presenti termini e condizioni.</p>
            ...
            <p>Lei concede a Unipeppers una licenza non esclusiva di usare, riprodurre, modificare e autorizza altri a usare, riprodurre e modificare qualsiasi Suo commento in ogni forma, formato o media.</p>
        
        <h3>Collegamenti ipertestuali ai nostri contenuti:</h3>
            ...
            <p>Nel caso in cui Lei rappresenti una delle organizzazioni indicate nel paragrafo 2 sopra e sia interessato ad aggiungere un collegamento al nostro sito, deve informarci inviando un'email a Unipeppers. Le chiediamo di includere nome, denominazione dell'organizzazione, informazioni di contatto e URL del sito, una lista di URL su cui intende aggiungere un collegamento al nostro sito e una lista di URL sul nostro sito che intende collegare. Le chiediamo di attendere 2-3 settimane per una risposta.</p>
            ...
            <p>Non è consentito uso di logo o immagini di Unipeppers per collegamenti in caso di mancanza di un accordo di licenza commerciale.</p>
        
        <h3>Responsabilità sui contenuti:</h3>
        ...
        <h3>Rimozione di collegamenti dal nostro sito:</h3>
